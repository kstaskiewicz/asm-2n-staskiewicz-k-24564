...
petla01:
    ...
    cmp r12, 0     ;operacja porownania
    jge petla01		;dopoki iterator >=0 to skaczemy
...
petla02:
    ...
    pop rax     ;zdejmujemy ze stosu
    mov rcx, 3
    xor rdx, rdx  ;zerowanie rejestru
    div rcx   ;dzielenie
    mov qword [tab01 + r12*8], rax		;zapis do tablicy
    inc r12		;powiekszamy iterator
    cmp r12, 10     ;operacja porownania
    jl petla02		;skok warunkowy dopoki r12<10
...
petla03:
    ...
    jg stop		;skok warunkowy gdy: qword[tab01 + 8*r12] > 255
...
stop:
    ...
    cmp r12, 10
    jl petla03		;skok warunkowy gdy wyczerpiemy cala tablice
